    ...
    <header className="flex items-center fixed top-0 left-0 w-full min-h-[60px] md:min-h-[78px] z-[999] bg-transparent transition-all duration-300">
      <div className="mx-auto px-4 md:px-8 max-w-[1600px] flex items-center justify-between md:justify-center relative h-full w-full">
        ...
        <nav className="hidden md:flex items-center justify-between w-full h-full">
          ...
          {/* Header Title - Centrado con la técnica exacta de Tenue */}
          <Link 
            href="/" 
            className="header-title absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 min-width-[220px] text-center text-[var(--color-text)] text-[clamp(16px,0.278vw+0.938rem,19px)] lowercase tracking-normal font-sans z-[22] transition-all duration-350 hover:text-[var(--color-text-hover)] group"
          >
            noreste arch
